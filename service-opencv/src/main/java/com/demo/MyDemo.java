...
public class MyDemo extends JPanel {
    ...
    public static Mat detectFace(Mat img) {
        ...
        CascadeClassifier faceDetector = new CascadeClassifier("D:\\Load\\lib\\opencv3.4.3\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
        CascadeClassifier eyeDetector = new CascadeClassifier("D:\\Load\\lib\\opencv3.4.3\\sources\\data\\haarcascades\\haarcascade_eye.xml");
...
//                        new Scalar(0, 0, 255), 2);
                ...
                if( eyesDetections.toArray().length > 1){
                    save(img, rect, "F:\\face\\"+r.nextInt(2000)+".jpg");
                }
