...
public class RandomValue<T> {
    ...
    public static JSONObject getAddress() {
        ...
        jsonObject.put("name", getChineseName());
        jsonObject.put("road", getRoad());
        jsonObject.put("mobile", getTel());
        jsonObject.put("email", getEmail(6,9));
        String identity = getIdentity();
        jsonObject.put("identity", identity);
        jsonObject.put("gender", Integer.parseInt(identity.substring(16,17)) % 2 == 0 ? "男" : "女");
        jsonObject.put("age",getBirAgeSex(identity).get("age"));
